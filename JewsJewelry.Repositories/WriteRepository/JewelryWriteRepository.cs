...
{
    public class JewelryWriteRepository : BasedWriteRepository<Jewelry>, IJewelryWriteRepository, IRepositoryMarker
    {
        public JewelryWriteRepository(IDBWriterContext writerContext)
            : base(writerContext) { }
    }
}
